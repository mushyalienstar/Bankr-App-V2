...
As this was created specifically to learn JavaScript, it is generally quite simple (static) and requires the user to enter their full name and a four-digit password.
